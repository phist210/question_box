...
router.register(r'commentquestion', views.QuestionCommentViewSet)
router.register(r'commentanswer', views.AnswerCommentViewSet)
router.register(r'votequestion', views.QuestionVoteViewSet)
router.register(r'voteanswer', views.AnswerVoteViewSet)
